...
(function (global, factory) {
  ...
  $('.FormularioAJAX').submit(function(e){
    ...
    if (tipo == "save"){
      ...
      textoAlerta = "¿Deseas cerrar la sesión actual?";
    }else if(tipo == "change"){
      textoAlerta = "¿Desea cambiar de estado la solicitud seleccionada?";
    }else if(tipo == "deny"){
      textoAlerta = "¿Desea rechazar la solicitud seleccionada?";
    }else if(tipo == "print"){
      textoAlerta = "¿Desea imprimir la solicitud seleccionada?";
    }else if(tipo == "cancel"){
      textoAlerta = "¿Desea Cancelar el registro de la Informacion?";
    }else{
    ...
    swal({
      ...
      confirmButtonText: '<i class="fa fa-check"></i> Si, Aceptar',
